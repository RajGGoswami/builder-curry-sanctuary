      ...
      <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto px-6 relative z-10 mt-20">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="text-text-gray font-arimo text-center max-w-2xl space-y-6">
            ...
            >
              This page is coming soon. Please continue prompting to help me
              build out this section with your specific content and
              requirements.
            </p>
            <p
            ...
            >
              I'd be happy to showcase your portfolio, case studies, and project
              highlights here.
            </p>
          </div>
        </div>
